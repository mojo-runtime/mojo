#ifndef _os_linux_mmap_anonymous_hxx_
#define _os_linux_mmap_anonymous_hxx_
...
namespace os { inline namespace _linux_ { namespace mmap_ {
...
anonymous(void* addr, size_t length, int prot, int flags) noexcept
{
    ...
    return Result<void*, Error>(__call(SYS_mmap, addr, length, prot, flags | MAP_ANONYMOUS));
}
