...
template <typename T, bool =   is_integral<T>::value> struct _is_signed_2 : integral_constant<bool, T(-1) < T(0)> {};
template <typename T, bool = is_arithmetic<T>::value> struct _is_signed_1 : _is_signed_2<T> {};
